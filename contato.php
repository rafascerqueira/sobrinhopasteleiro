...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="content">
      ...
      <form class="contatoForm" action="send.php" method="post">
        <fieldset id="cForm"><legend>Preenchimento de campos</legend>
          <label for="cNome">Nome </label><input type="text" name="nome" id="cNome" placeholder="Nome Completo" required><br>
          <label for="cEmail">Email </label><input type="email" name="email" id="cEmail" placeholder="voce@email.com" required><br>
          <label for="cMsg">Mensagem </label><br><textarea name="mensagem" id="cMsg"></textarea><br>
