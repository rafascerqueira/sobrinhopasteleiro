...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="content">
      <h2>Home > Sim-invest</h2>
      <br><br>
      <h1 style="text-align: center;">EM MANUTENÇÃO - FAOVR RETORNAR MAIS TARDE!</h1>
      <div style="text-align: center;"><img src="img/Manutenção.png" alt="Em manutenção" /></div>
